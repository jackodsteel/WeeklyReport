            ...
            if submission.author:
                ...
                if submission.gilded > 0:
                    gilded_submissions.append(str(
                        submission.score) + '|/u/' + submission.author.name + '|[' + submission.title + '](' + submission.short_link + ')|' + str(
                        submission.gilded) + 'X')
                            ...
                            if comment.author and comment.banned_by == None:
                                ...
                                if comment.gilded > 0:
                                    gilded_comments.append(str(
                                        comment.score) + '|/u/' + comment.author.name + '|[' + submission.title + '](' + submission.short_link + ')|' + str(
                                        comment.gilded) + 'X')
